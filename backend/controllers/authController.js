...
// VERSÃO FINAL CORRIGIDA - Protocolo DEV.SENIOR v2.2
...
/**
 * Registro de novo usuário (sem alterações)
 */
...
/**
 * Login com email e senha (sem alterações)
 */
...
/**
 * ESQUECI MINHA SENHA - CORRIGIDO (Lei nº 31)
 */
exports.forgotPassword = async (req, res) => {
    ...
    try {
        ...
        // --- CORREÇÃO CRÍTICA ---
        // Agora usa o serviço centralizado para criar o token na coleção CORRETA
...
/**
 * REDEFINIÇÃO DE SENHA - CORRIGIDO (Lei nº 31)
 */
exports.resetPassword = async (req, res) => {
    ...
    try {
        // --- CORREÇÃO CRÍTICA ---
        // Agora verifica o token na coleção CORRETA (passwordResetTokens)
...
/**
 * Login com Google (sem alterações)
 */
